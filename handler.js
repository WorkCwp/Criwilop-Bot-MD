...
global.dfail = (type, m, conn) => {
    ...
    ${userTag} Este comando sólo puede ser utilizado por el *Propietario del Bot*!`,
        moderator: `*${emoji.moderator} Consulta del moderador*\n
    ${userTag} Este comando sólo puede ser utilizado por *Moderadores*!`,
        premium: `*${emoji.premium} Consulta Premium*\n
    ${userTag} Este comando es sólo para *Miembros Premium*!`,
        group: `*${emoji.group} Consulta de grupo*\n
    ${userTag} ¡Este comando solo se puede usar en *Chats grupales*!`,
        private: `*${emoji.private} Consulta privada*\n
    ${userTag} ¡Este comando solo se puede usar en *Chats privados*!`,
        admin: `*${emoji.admin} Consulta del administrador*\n
    ${userTag} ¡Este comando es sólo para *Administradores de grupo*!`,
        botAdmin: `*${emoji.botAdmin} Consulta del administrador del bot*\n
    ${userTag} ¡Haz que el bot sea *Administrador* para usar este comando!`,
        unreg: `*${emoji.unreg} Consulta de registro*\n
    ${userTag} Regístrese para utilizar esta función escribiendo:\n\n*#register Nombre.Edad*\n\nEjemplo: *#register ${m.name}.18*!`,
        nsfw: `*${emoji.nsfw} Consulta NSFW*\n
    ${userTag} NSFW no está activo. ¡Comuníquese con el administrador del grupo para habilitar esta función!`,
        restrict: `*${emoji.restrict} Consulta de función inactiva*\n
    ${userTag} Esta característica está *deshabilitada*!`,
    }
     [type]
