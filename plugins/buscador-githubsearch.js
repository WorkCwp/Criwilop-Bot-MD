...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  if (!text) throw `*⚠️ Ingresa un texto para buscar, ejemplo: ${usedPrefix + command} TheMystic-Bot-MD*`;
