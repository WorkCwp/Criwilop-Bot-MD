...
if (!tiktok) throw '*⚠️ Ingresa un enlace de tiktok imagenes, ejemplo: "https://vm.tiktok.com/ZM2cqBRVS/".*';        
let imagesSent
...
imagesSent = false
    ...
    imagesSent = false    
    throw '*⚠️ No se obtuvo respuesta de la página, intente más tarde.*'
 }
};
