    ...
    if (timeDifference < 10000) {
        ...
        if (this.spam[m.sender].count >= 5) {
            ...
            setTimeout(() => {
                ...
                m.reply(`✅ *tiempo de reutilización terminado*\Puedes enviar mensajes nuevamente..`);
            }, 5000);
            ...
            return m.reply(`❌ *Puedes enviar mensajes nuevamente. no spam ${message}*\Esperar ${Math.ceil((this.spam[m.sender].lastspam - now) / 1000)} seconds`);
        }
    } else {
