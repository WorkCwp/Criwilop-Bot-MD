...
const handler = async (m, {conn, text, isMods, isOwner, isPrems}) => {
 if (enviando) return;
  ...
  try {
    ...
    if (!link || !link.match(linkRegex)) throw '*⚠️ Link erroneo o faltante, ingrese el enlace de un grupo de WhatsApp.*\n\n*—◉ Ejemplo:*\n*◉ #join https://chat.whatsapp.com/FwEUGxkvZD85fIIp0gKyFC*';
