...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  ...
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      if (!img) throw `*⚠️ ʀᴇsᴘᴏɴᴅᴇ ᴀ ᴜɴᴀ ɪᴍᴀɢᴇɴ/ɢɪғ ᴘᴀʀᴀ ᴄᴏɴᴠᴇʀᴛɪʀ ᴇɴ sᴛɪᴄᴋᴇʀ *`;
      let out;
      try {
      ...
      else return m.reply('*⚠️ ʟᴀ ɪᴍᴀɢᴇɴ ǫᴜᴇ ᴅᴇsᴇᴀ ᴄᴏɴᴠᴇʀᴛɪʀ ɴᴏ ᴛɪᴇɴᴇ ᴇʟ ғᴏʀᴍᴀᴛᴏ ᴘɴɢ/ᴊᴘɢ*');
    }
  } catch (e) {
    console.error(e);
    if (!stiker) stiker = e;
    ...
    else throw '*⚠️ ᴇʀʀᴏʀ, ᴘᴏʀғᴀᴠᴏʀ ɪɴᴛᴇɴᴛᴀʟᴏ ᴅᴇ ɴᴜᴇᴠᴏ ᴄᴏɴ ᴜɴᴀ ɪᴍᴀɢᴇɴ ᴄᴏɴ ғᴏʀᴍᴀᴛᴏ ᴘɴɢ/ᴊᴘɢ*';
  }
};
handler.help = ['sfull'];
