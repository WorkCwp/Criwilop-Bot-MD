...
if (!args[0] && !m.quoted) throw `⚠️ Dame el enlace del video Tiktok o cita un enlace de tiktok`;
 if (!args[0].match(/tiktok/gi)) throw `⚠️ Verifica que el enlace sea de TikTok`;
