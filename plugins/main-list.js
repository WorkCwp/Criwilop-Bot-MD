let handler = async (m, { conn, usedPrefix, command}) => {
     ...
     let lkr;
      ...
      switch (command) {
        ...
        case 'menu':
lkr = "*Prepárate para la aventura, aquí están tus opciones de ticket:*\n\n" +
        "🤖 *" + usedPrefix + "botmenu* - El panel de control secreto del Bot. ¿Cuál es tu comando, oh gran uno?\n\n" +
        "👑 *" + usedPrefix + "ownermenu* - El pergamino sagrado solo para el elegido. Sí, eres tú, Jefe!\n\n" +
        "🧑‍🤝‍🧑 *" + usedPrefix + "groupmenu* - ¡Central de travesuras grupales! ¡Únete, chatea, conquista!\n\n" +
        "📥 *" + usedPrefix + "dlmenu* - 'DL' significa 'Loot Delicioso'. ¡Ven a buscar tus golosinas!\n\n" +
        "🎉 *" + usedPrefix + "funmenu* - El sombrero de fiesta del bot. Juegos, chistes y carcajadas instantáneas. ¡Que comience la fiesta!\n\n" +
        "💰 *" + usedPrefix + "economymenu* - ¡Bling bling! Tu bóveda personal de economía virtual. ¿Gastar o guardar? Elige sabiamente!\n\n" +
        "🎮 *" + usedPrefix + "gamemenu* - Entra en la arena de juegos. ¡Que las probabilidades estén siempre a tu favor!\n\n" +
        "🎨 *" + usedPrefix + "stickermenu* - Un arcoíris de stickers para tu artista interior. ¡Haz que tus chats destaquen!\n\n" +
        "🧰 *" + usedPrefix + "toolmenu* - Tu kit de herramientas práctico. ¿Cuál es tu elección, genio?\n\n" +
        "🎩 *" + usedPrefix + "logomenu* - Crea un logo que grite TÚ. O susurre. Tú eliges el volumen.\n\n" +
        "🌙 *" + usedPrefix + "nsfwmenu* - El menú de la Noche. Pero recuerda, compartir secretos adultos debe ser basado en el consentimiento.";
break;
   ...
   ┗━━━ʕ•㉨•ʔ━━━┛`; // 
    ...
    handler.help = ['menu', 'botmenu', 'ownermenu', 'groupmenu', 'dlmenu', 'downloadermenu', 'economymenu', 'funmenu', 'gamemenu', 'stickermenu', 'nsfwmenu', 'logomenu', 'toolmenu'];
    handler.tags = ['main'];
    handler.command = ['menu', 'botmenu', 'ownermenu', 'groupmenu', 'dlmenu', 'downloadermenu', 'economymenu', 'funmenu', 'gamemenu', 'stickermenu', 'nsfwmenu', 'logomenu', 'toolmenu'];
